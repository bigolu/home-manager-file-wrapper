...
in
{
  options.fileWrapper =
    let
      ...
      executable = mkOption {
        ...
        # are considered.
        internal = config.fileWrapper.settings.editableInstall;
        readOnly = config.fileWrapper.settings.editableInstall;
      };
      recursive = mkOption {
        type = types.bool;
        default = false;
          ...
          target = mkOption {
            ...
            apply =
              ...
              if submoduleContext.config.recursive then
                config.fileWrapper.xdg.executableHome
              else
                "${config.fileWrapper.xdg.executableHome}/${value}";
          };
        };
        config = {
          target = mkDefault submoduleContext.config._module.args.name;
      ...
      settings = {
        ...
        relativePathRoot = {
          symlink = mkOption {
            ...
            default = config.fileWrapper.settings.relativePathRoot.access;
          };
  ...
  config =
    let
      ...
      toHomeManagerFile =
        ...
        let
          ...
          isEditableInstall = config.fileWrapper.settings.editableInstall;
      ...
      getHomeManagerFileSetForFilesInDirectory =
        ...
        pipe directory.source [
          ...
          # `fileWrapper.settings.relativePathRoot.access` doesn't match
          # `fileWrapper.settings.relativePathRoot.symlink`.
          listRelativeFilesRecursive
    ...
    in
    {
      ...
      xdg.configFile = toHomeManagerFileSet config.fileWrapper.xdg.configFile;
      xdg.dataFile = toHomeManagerFileSet config.fileWrapper.xdg.dataFile;
    };
}
